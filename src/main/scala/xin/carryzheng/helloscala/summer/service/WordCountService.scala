package xin.carryzheng.helloscala.summer.service

import xin.carryzheng.helloscala.summer.common.TService
import xin.carryzheng.helloscala.summer.dao.WordCountDao
